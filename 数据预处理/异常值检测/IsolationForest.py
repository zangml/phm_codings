...
params['path'] = '/usr/local/data/lab_shouce/iso_train.csv'
params['opath'] ='/usr/local/data/lab_shouce/iso_train_iso.csv'
argvs = sys.argv
try:
...
#对所有数据行进行异常检测
    ...
    clf = IsolationForest(n_estimators=params['n_estimators'], 
                          ...
                          bootstrap=False, n_jobs=1, random_state=None, verbose=0).fit(train_x)
